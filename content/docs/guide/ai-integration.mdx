...
```
https://doc.x-lf.com/llms.mdx/docs/beacon-sso/go-sdk/quick-start
https://doc.x-lf.com/llms.mdx/docs/beacon-sso/java-sdk/quick-start
```
...
如果你使用 Claude Code 命令行工具，可以通过 MCP 服务直接集成锋翎文档，让 Claude 自动获取所需文档内容。
...
- **Beacon SSO 全局文档**: https://doc.x-lf.com/llms.txt
